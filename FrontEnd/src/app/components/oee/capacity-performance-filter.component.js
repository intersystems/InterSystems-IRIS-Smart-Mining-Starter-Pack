      ...
      return OEE
        ...
        .then(categories => {
          ...
          for (let category of categories) {
            if (category.name !== $translate.instant('components.oee.capacity-performance-filter._truckCategoryLabel') /* && category.name !== 'Carguio'*/) {
              category.disabled = true;
            }
          }

          const truckCategory = vm.categories.find(current => current.name === $translate.instant('components.oee.capacity-performance-filter._truckCategoryLabel'));
